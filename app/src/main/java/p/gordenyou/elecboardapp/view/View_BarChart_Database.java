...
public class View_BarChart_Database extends DemoView implements Runnable { //DemoView
	...
	public View_BarChart_Database(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}

	public View_BarChart_Database(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
	 }

	 public View_BarChart_Database(Context context, AttributeSet attrs, int defStyle) {
	...
	private void chartRender()
	{
		try {
			...
			//轴标题
			chart.getAxisTitle().setLeftTitle("数据库类型");
