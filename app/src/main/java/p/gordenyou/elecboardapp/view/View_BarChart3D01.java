 ...
 * @author XiongChuanLiang<br/>(xcl_168@aliyun.com)
 */
public class View_BarChart3D01 extends DemoView {
	...
	public View_BarChart3D01(Context context) {
		super(context);
	...
	public View_BarChart3D01(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
	 }

	 public View_BarChart3D01(Context context, AttributeSet attrs, int defStyle) {
...
//			chart.showRoundBorder();
			...
			chart.getCategoryAxis().setTickLabelRotateAngle(-45);
