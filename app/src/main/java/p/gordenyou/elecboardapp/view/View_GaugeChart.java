 ...
 * @Description  仪表盘例子
 */
public class View_GaugeChart extends GraphicalView {
	...
	public View_GaugeChart(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}

	public View_GaugeChart(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
	 }

	 public View_GaugeChart(Context context, AttributeSet attrs, int defStyle) {
