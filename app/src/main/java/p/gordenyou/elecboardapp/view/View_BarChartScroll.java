...
public class View_BarChartScroll extends GraphicalView {
    ...
    public View_BarChartScroll(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        initView();
    }

    public View_BarChartScroll(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public View_BarChartScroll(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void chartRender() {
        try {
            ...
            chart.getBar().getBarPaint().setTextSize(15);
